...
class Music {
    ...
    back() {
        this.music = new Sound("music/back.mp3");
        this.music.play();
    }

    punch() {
        this.music = new Sound("music/punch.mp3");
        this.music.play();
    }

    shot() {
        this.tingSound = new Sound("music/shot.mp3");
        this.tingSound.play();
    }

    sparta() {
        this.hornSound = new Sound("music/sparta.mp3");
        this.hornSound.play();
    }
...
class Engine {
    ...
    start() {
        ...
        document.addEventListener('keydown', e => {
            ...
            //_________________________________ shooting once at a time
            else if (e.keyCode === SHOOT_ARROW_CODE) {

              if (!this.bullet.boom || this.bullet.y > 450) {
                this.bullet.shoot(this.player.x);
                this.gameMusic.shot();
              }
            } //_________________________________________________________

             else if (e.keyCode === 32 && this.isPlayerDead()) {
                this.gameMusic.sparta();
                this.score = 0;
                this.gameLoop();
            }
        });
    ...
    gameLoop() {
        ...
        if (this.isPlayerDead()) {
            ...
            this.ctx.fillText('PRESS SPACE', 105, 280);
            console.log("dead");
            // create button
            // var button = {}; //initialized
            //
            // var rere = document.addEventListener();
            // //
            //
    ...
    !this.bullet.nomore)
        { delete this.enemies[i];
          this.gameMusic.punch();
          this.bullet.nomore = true;
        }
      }
    }
